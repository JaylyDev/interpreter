 ...
 * related to administering a Bedrock Dedicated Server.
 * 
 * These types allow for the configuration of variables and
 * secrets in JSON files in the Bedrock Dedicated Server folder.
 * 
 * Manifest Details
 * ```json
 * {
 ...
 * ```
 */
declare module "mojang-minecraft-server-admin" {
    /**
