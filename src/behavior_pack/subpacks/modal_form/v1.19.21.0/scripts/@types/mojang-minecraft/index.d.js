...
declare namespace mojangminecraft {
    ...
    export class BlockHitInformation { readonly 'block': Block; readonly 'face': Direction; readonly 'faceLocationX': number; readonly 'faceLocationY': number; protected constructor(); } 
    ...
    export class DynamicPropertiesDefinition { constructor(); defineBoolean(identifier: string): void; defineNumber(identifier: string): void; defineString(identifier: string, maxLength: number): void; } 
    ...
    export class Entity { readonly 'bodyRotation': number; readonly 'dimension': Dimension; readonly 'headLocation': Location; readonly 'id': string; 'isSneaking': boolean; readonly 'location': Location; 'nameTag': string; 'target': Entity; readonly 'velocity': Vector; readonly 'viewVector': Vector; addEffect(effectType: EffectType, duration: number, amplifier?: number, showParticles?: boolean): void; addTag(tag: string): boolean; getBlockFromViewVector(options?: BlockRaycastOptions): Block; getComponent(componentId: string): IEntityComponent; getComponents(): IEntityComponent[]; getDynamicProperty(identifier: string): boolean | number | string; getEffect(effectType: EffectType): Effect; getEntitiesFromViewVector(options?: EntityRaycastOptions): Entity[]; getTags(): string[]; hasComponent(componentId: string): boolean; hasTag(tag: string): boolean; kill(): void; removeDynamicProperty(identifier: string): boolean; removeTag(tag: string): boolean; runCommand(commandString: string): any; setDynamicProperty(identifier: string, value: boolean | number | string): void; setVelocity(velocity: Vector): void; teleport(location: Location, dimension: Dimension, xRotation: number, yRotation: number): void; teleportFacing(location: Location, dimension: Dimension, facingLocation: Location): void; triggerEvent(eventName: string): void; protected constructor(); } 
    ...
    export class EntityHitInformation { readonly 'entity': Entity; protected constructor(); } 
    ...
    export class ItemCompleteChargeEvent { readonly 'itemStack': ItemStack; readonly 'source': Entity; readonly 'useDuration': number; protected constructor(); } 
    export class ItemCompleteChargeEventSignal { subscribe(callback: (arg: ItemCompleteChargeEvent) => void): (arg: ItemCompleteChargeEvent) => void; unsubscribe(callback: (arg: ItemCompleteChargeEvent) => void): void; protected constructor(); } 
    ...
    export class ItemReleaseChargeEvent { readonly 'itemStack': ItemStack; readonly 'source': Entity; readonly 'useDuration': number; protected constructor(); } 
    export class ItemReleaseChargeEventSignal { subscribe(callback: (arg: ItemReleaseChargeEvent) => void): (arg: ItemReleaseChargeEvent) => void; unsubscribe(callback: (arg: ItemReleaseChargeEvent) => void): void; protected constructor(); } 
    ...
    export class ItemStartChargeEvent { readonly 'itemStack': ItemStack; readonly 'source': Entity; readonly 'useDuration': number; protected constructor(); } 
    export class ItemStartChargeEventSignal { subscribe(callback: (arg: ItemStartChargeEvent) => void): (arg: ItemStartChargeEvent) => void; unsubscribe(callback: (arg: ItemStartChargeEvent) => void): void; protected constructor(); } 
    export class ItemStartUseOnEvent { readonly 'blockFace': Direction; readonly 'blockLocation': BlockLocation; readonly 'buildBlockLocation': BlockLocation; 'item': ItemStack; readonly 'source': Entity; protected constructor(); } 
    export class ItemStartUseOnEventSignal { subscribe(callback: (arg: ItemStartUseOnEvent) => void): (arg: ItemStartUseOnEvent) => void; unsubscribe(callback: (arg: ItemStartUseOnEvent) => void): void; protected constructor(); } 
    export class ItemStopChargeEvent { readonly 'itemStack': ItemStack; readonly 'source': Entity; readonly 'useDuration': number; protected constructor(); } 
    export class ItemStopChargeEventSignal { subscribe(callback: (arg: ItemStopChargeEvent) => void): (arg: ItemStopChargeEvent) => void; unsubscribe(callback: (arg: ItemStopChargeEvent) => void): void; protected constructor(); } 
    export class ItemStopUseOnEvent { readonly 'blockLocation': BlockLocation; 'item': ItemStack; readonly 'source': Entity; protected constructor(); } 
    export class ItemStopUseOnEventSignal { subscribe(callback: (arg: ItemStopUseOnEvent) => void): (arg: ItemStopUseOnEvent) => void; unsubscribe(callback: (arg: ItemStopUseOnEvent) => void): void; protected constructor(); } 
    ...
    export class LeverActionEvent extends BlockEvent { readonly 'block': Block; readonly 'dimension': Dimension; readonly 'isPowered': boolean; readonly 'player': Player; protected constructor(); } 
    ...
    export class MusicOptions { 'fade': number; 'loop': boolean; 'volume': number; constructor(); } 
    ...
    export class Player extends Entity { readonly 'bodyRotation': number; readonly 'dimension': Dimension; readonly 'headLocation': Location; readonly 'id': string; 'isSneaking': boolean; readonly 'location': Location; readonly 'name': string; 'nameTag': string; readonly 'onScreenDisplay': ScreenDisplay; 'selectedSlot': number; 'target': Entity; readonly 'velocity': Vector; readonly 'viewVector': Vector; addEffect(effectType: EffectType, duration: number, amplifier?: number, showParticles?: boolean): void; addTag(tag: string): boolean; getBlockFromViewVector(options?: BlockRaycastOptions): Block; getComponent(componentId: string): IEntityComponent; getComponents(): IEntityComponent[]; getDynamicProperty(identifier: string): boolean | number | string; getEffect(effectType: EffectType): Effect; getEntitiesFromViewVector(options?: EntityRaycastOptions): Entity[]; getItemCooldown(itemCategory: string): number; getTags(): string[]; hasComponent(componentId: string): boolean; hasTag(tag: string): boolean; kill(): void; playSound(soundID: string, soundOptions?: SoundOptions): void; removeDynamicProperty(identifier: string): boolean; removeTag(tag: string): boolean; runCommand(commandString: string): any; setDynamicProperty(identifier: string, value: boolean | number | string): void; setVelocity(velocity: Vector): void; startItemCooldown(itemCategory: string, tickDuration: number): void; teleport(location: Location, dimension: Dimension, xRotation: number, yRotation: number): void; teleportFacing(location: Location, dimension: Dimension, facingLocation: Location): void; triggerEvent(eventName: string): void; protected constructor(); } 
    ...
    export class ProjectileHitEvent { readonly 'blockHit': BlockHitInformation; readonly 'dimension': Dimension; readonly 'entityHit': EntityHitInformation; readonly 'hitVector': Vector; readonly 'location': Location; readonly 'projectile': Entity; readonly 'source': Entity; protected constructor(); } 
    export class ProjectileHitEventSignal { subscribe(callback: (arg: ProjectileHitEvent) => void): (arg: ProjectileHitEvent) => void; unsubscribe(callback: (arg: ProjectileHitEvent) => void): void; protected constructor(); } 
    export class PropertyRegistry { registerEntityTypeDynamicProperties(propertiesDefinition: DynamicPropertiesDefinition, entityType: EntityType,): void; registerWorldDynamicProperties(propertiesDefinition: DynamicPropertiesDefinition): void; protected constructor(); } 
    export class ScreenDisplay { clearTitle(): void; setActionBar(text: string): void; setTitle(title: string, options?: TitleDisplayOptions): void; updateSubtitle(subtitle: string): void; protected constructor(); } 
    ...
    export class TitleDisplayOptions { 'fadeInSeconds': number; 'fadeOutSeconds': number; 'staySeconds': number; 'subtitle': string; constructor(); } 
    ...
    export class World { readonly 'events': Events; getDimension(dimensionId: string): Dimension; getDynamicProperty(identifier: string): boolean | number | string; getPlayers(options?: EntityQueryOptions): PlayerIterator; playMusic(trackID: string, musicOptions?: MusicOptions): void; playSound(soundID: string, soundOptions?: SoundOptions): void; queueMusic(trackID: string, musicOptions?: MusicOptions): void; removeDynamicProperty(identifier: string): boolean; setDynamicProperty(identifier: string, value: boolean | number | string): void; stopMusic(): void; protected constructor(); } 
    export class WorldInitializeEvent { readonly 'propertyRegistry': PropertyRegistry; protected constructor(); } 
    export class WorldInitializeEventSignal { subscribe(callback: (arg: WorldInitializeEvent) => void): (arg: WorldInitializeEvent) => void; unsubscribe(callback: (arg: WorldInitializeEvent) => void): void; protected constructor(); } 
