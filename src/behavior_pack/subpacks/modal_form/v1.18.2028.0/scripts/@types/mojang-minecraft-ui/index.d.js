...
export const Namespace = `declare namespace mojangminecraftui {
    ...
    export class ActionFormResponse extends FormResponse { readonly 'isCanceled': boolean; readonly 'selection': number; protected constructor(); }
    export class FormResponse { readonly 'isCanceled': boolean; protected constructor(); }
    ...
    export class MessageFormResponse extends FormResponse { readonly 'isCanceled': boolean; readonly 'selection': number; protected constructor(); }
    ...
    export class ModalFormResponse extends FormResponse { readonly 'formValues': any[]; readonly 'isCanceled': boolean; protected constructor(); }
}`