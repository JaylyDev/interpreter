export const mojangminecraft_d_ts = `// Type definitions for Minecraft Bedrock Edition script APIs (experimental) 0.1
...
declare namespace mojangminecraft {
    ...
    export enum GameMode { survival = 0, creative = 1, adventure = 2, }
    export class BeforeChatEvent { "cancel": boolean; "message": string; "sender": Player; "sendToTargets": boolean; "targets": Player[]; }
    export class BeforeChatEventSignal { subscribe(callback: (arg: BeforeChatEvent) => void): (arg: BeforeChatEvent) => void; unsubscribe(callback: (arg: BeforeChatEvent) => void): void; }
    export class BeforeDataDrivenEntityTriggerEvent { "cancel": boolean; readonly "entity": Entity; readonly "id": string; "modifiers": DefinitionModifier[]; }
    export class BeforeDataDrivenEntityTriggerEventSignal { subscribe(callback: (arg: BeforeDataDrivenEntityTriggerEvent) => void, options?: EntityDataDrivenTriggerEventOptions): (arg: BeforeDataDrivenEntityTriggerEvent) => void; unsubscribe(callback: (arg: BeforeDataDrivenEntityTriggerEvent) => void): void; }
    export class BeforeExplosionEvent { "cancel": boolean; readonly "dimension": Dimension; "impactedBlocks": BlockLocation[]; readonly "source": Entity; }
    export class BeforeExplosionEventSignal { subscribe(callback: (arg: BeforeExplosionEvent) => void): (arg: BeforeExplosionEvent) => void; unsubscribe(callback: (arg: BeforeExplosionEvent) => void): void; }
    export class BeforeItemDefinitionEventSignal { subscribe(callback: (arg: BeforeItemDefinitionTriggeredEvent) => void): (arg: BeforeItemDefinitionTriggeredEvent) => void; unsubscribe(callback: (arg: BeforeItemDefinitionTriggeredEvent) => void): void; }
    export class BeforeItemDefinitionTriggeredEvent { "cancel": boolean; readonly "eventName": string; "item": ItemStack; readonly "source": Entity; }
    export class BeforeItemUseEvent { "cancel": boolean; "item": ItemStack; readonly "source": Entity; }
    export class BeforeItemUseEventSignal { subscribe(callback: (arg: BeforeItemUseEvent) => void): (arg: BeforeItemUseEvent) => void; unsubscribe(callback: (arg: BeforeItemUseEvent) => void): void; }
    export class BeforeItemUseOnEvent { readonly "blockFace": Direction; readonly "blockLocation": BlockLocation; "cancel": boolean; readonly "faceLocationX": number; readonly "faceLocationY": number; "item": ItemStack; readonly "source": Entity; }
    export class BeforeItemUseOnEventSignal { subscribe(callback: (arg: BeforeItemUseOnEvent) => void): (arg: BeforeItemUseOnEvent) => void; unsubscribe(callback: (arg: BeforeItemUseOnEvent) => void): void; }
    export class BeforePistonActivateEvent extends BlockEvent { readonly "block": Block; "cancel": boolean; readonly "dimension": Dimension; readonly "isExpanding": boolean; readonly "piston": BlockPistonComponent; }
    export class BeforePistonActivateEventSignal { subscribe(callback: (arg: BeforePistonActivateEvent) => void): (arg: BeforePistonActivateEvent) => void; unsubscribe(callback: (arg: BeforePistonActivateEvent) => void): void; }
    export class Block { readonly "dimension": Dimension; readonly "id": string; readonly "isEmpty": boolean; "isWaterlogged": boolean; readonly "location": BlockLocation; readonly "permutation": BlockPermutation; readonly "type": BlockType; readonly "x": number; readonly "y": number; readonly "z": number; getComponent(componentName: string): any; getTags(): string[]; hasTag(tag: string): boolean; setPermutation(permutation: BlockPermutation): void; setType(blockType: BlockType): void; }
    ...
    export class BlockBreakEvent extends BlockEvent { readonly "block": Block; readonly "brokenBlockPermutation": BlockPermutation; readonly "dimension": Dimension; readonly "player": Player; }
    export class BlockBreakEventSignal { subscribe(callback: (arg: BlockBreakEvent) => void): (arg: BlockBreakEvent) => void; unsubscribe(callback: (arg: BlockBreakEvent) => void): void; }
    export class BlockComponent { }
    export class BlockEvent { readonly "block": Block; readonly "dimension": Dimension; }
    export class BlockExplodeEvent extends BlockEvent { readonly "block": Block; readonly "destroyedBlockPermutation": BlockPermutation; readonly "dimension": Dimension; readonly "source": Entity; }
    export class BlockExplodeEventSignal { subscribe(callback: (arg: BlockExplodeEvent) => void): (arg: BlockExplodeEvent) => void; unsubscribe(callback: (arg: BlockExplodeEvent) => void): void; }
    export class BlockInventoryComponent { readonly "container": BlockInventoryComponentContainer; readonly "location": BlockLocation; }
    ...
    export class BlockLavaContainerComponent { "fillLevel": number; readonly "location": BlockLocation; }
    ...
    export class BlockPermutation { readonly "type": BlockType; clone(): BlockPermutation; getAllProperties(): IBlockProperty[]; getProperty(propertyName: string): IBlockProperty; getTags(): string[]; hasTag(tag: string): boolean; }
    export class BlockPistonComponent { readonly "attachedBlocks": BlockLocation[]; readonly "isExpanded": boolean; readonly "isExpanding": boolean; readonly "isMoving": boolean; readonly "isRetracted": boolean; readonly "isRetracting": boolean; readonly "location": BlockLocation; }
    export class BlockPlaceEvent extends BlockEvent { readonly "block": Block; readonly "dimension": Dimension; readonly "player": Player; }
    export class BlockPlaceEventSignal { subscribe(callback: (arg: BlockPlaceEvent) => void): (arg: BlockPlaceEvent) => void; unsubscribe(callback: (arg: BlockPlaceEvent) => void): void; }
    export class BlockPotionContainerComponent { "fillLevel": number; readonly "location": BlockLocation; setPotionType(item: ItemStack): void; }
    ...
    export class BlockRecordPlayerComponent { clearRecord(): void; isPlaying(): boolean; setRecord(recordItemType: ItemType): void; }
    export class BlockSnowContainerComponent { "fillLevel": number; readonly "location": BlockLocation; }
    export class BlockType { readonly "canBeWaterlogged": boolean; readonly "id": string; createDefaultBlockPermutation(): BlockPermutation; }
    export class BlockWaterContainerComponent { "customColor": Color; "fillLevel": number; readonly "location": BlockLocation; addDye(itemType: ItemType): void; }
    export class BoolBlockProperty extends IBlockProperty { readonly "name": string; readonly "validValues": boolean[]; "value": boolean; }
    export class ChatEvent { "message": string; "sender": Player; "sendToTargets": boolean; "targets": Player[]; }
    export class ChatEventSignal { subscribe(callback: (arg: ChatEvent) => void): (arg: ChatEvent) => void; unsubscribe(callback: (arg: ChatEvent) => void): void; }
    ...
    export class DataDrivenEntityTriggerEvent { readonly "entity": Entity; readonly "id": string; readonly "modifiers": DefinitionModifier[]; }
    export class DataDrivenEntityTriggerEventSignal { subscribe(callback: (arg: DataDrivenEntityTriggerEvent) => void, options?: EntityDataDrivenTriggerEventOptions): (arg: DataDrivenEntityTriggerEvent) => void; unsubscribe(callback: (arg: DataDrivenEntityTriggerEvent) => void): void; }
    ...
    export class Effect { readonly "amplifier": number; readonly "displayName": string; readonly "duration": number; }
    export class EffectAddEvent { "effect": Effect; "effectState": number; "entity": Entity; }
    export class EffectAddEventSignal { subscribe(callback: (arg: EffectAddEvent) => void, options?: EntityEventOptions): (arg: EffectAddEvent) => void; unsubscribe(callback: (arg: EffectAddEvent) => void): void; }
    export class EffectType { getName(): string; }
    ...
    export class EnchantmentType { readonly "id": string; readonly "maxLevel": number; }
    export class Entity { readonly "bodyRotation": number; readonly "dimension": Dimension; readonly "headLocation": Location; readonly "id": string; "isSneaking": boolean; readonly "location": Location; "nameTag": string; "target": Entity; readonly "velocity": Vector; readonly "viewVector": Vector; addEffect(effectType: EffectType, duration: number, amplifier: number): void; addTag(tag: string): boolean; getBlockFromViewVector(options?: BlockRaycastOptions): Block; getComponent(componentId: string): IEntityComponent; getComponents(): IEntityComponent[]; getEffect(effectType: EffectType): Effect; getEntitiesFromViewVector(options?: EntityRaycastOptions): Entity[]; getTags(): string[]; hasComponent(componentId: string): boolean; hasTag(tag: string): boolean; kill(): void; removeTag(tag: string): boolean; runCommand(commandString: string): any; setVelocity(velocity: Vector): void; teleport(location: Location, dimension: Dimension, xRotation: number, yRotation: number): void; teleportFacing(location: Location, dimension: Dimension, facingLocation: Location): void; triggerEvent(eventName: string): void; }
    export class EntityAddRiderComponent extends IEntityComponent { readonly "entityType": string; readonly "id": string; readonly "spawnEvent": string; }
    export class EntityAgeableComponent extends IEntityComponent { readonly "dropItems": string[]; readonly "duration": number; readonly "feedItems": EntityDefinitionFeedItem[]; readonly "growUp": Trigger; readonly "id": string; }
    ...
    export class EntityCanClimbComponent extends IEntityComponent { readonly "id": string; }
    export class EntityCanFlyComponent extends IEntityComponent { readonly "id": string; }
    export class EntityCanPowerJumpComponent extends IEntityComponent { readonly "id": string; }
    export class EntityColorComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityCreateEvent { "entity": Entity; }
    export class EntityCreateEventSignal { subscribe(callback: (arg: EntityCreateEvent) => void): (arg: EntityCreateEvent) => void; unsubscribe(callback: (arg: EntityCreateEvent) => void): void; }
    export class EntityDataDrivenTriggerEventOptions { "entities": Entity[]; "entityTypes": string[]; "eventTypes": string[]; constructor(); }
    export class EntityDefinitionFeedItem { readonly "growth": number; readonly "item": string; }
    export class EntityEventOptions { "entities": Entity[]; "entityTypes": string[]; constructor(); }
    export class EntityFireImmuneComponent extends IEntityComponent { readonly "id": string; }
    export class EntityFloatsInLiquidComponent extends IEntityComponent { readonly "id": string; }
    export class EntityFlyingSpeedComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityFrictionModifierComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityGroundOffsetComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityHealableComponent extends IEntityComponent { readonly "filters": FilterGroup; readonly "forceUse": boolean; readonly "id": string; readonly "items": FeedItem[]; }
    export class EntityHealthComponent extends IEntityComponent { readonly "current": number; readonly "id": string; readonly "value": number; resetToDefaultValue(): void; resetToMaxValue(): void; resetToMinValue(): void; setCurrent(value: number): void; }
    export class EntityHitEvent { readonly "entity": Entity; readonly "hitBlock": Block; readonly "hitEntity": Entity; }
    export class EntityHitEventSignal { subscribe(callback: (arg: EntityHitEvent) => void, options?: EntityEventOptions): (arg: EntityHitEvent) => void; unsubscribe(callback: (arg: EntityHitEvent) => void): void; }
    export class EntityInventoryComponent extends IEntityComponent { readonly "additionalSlotsPerStrength": number; readonly "canBeSiphonedFrom": boolean; readonly "container": InventoryComponentContainer; readonly "containerType": string; readonly "id": string; readonly "inventorySize": number; readonly "private": boolean; readonly "restrictToOwner": boolean; }
    export class EntityIsBabyComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsChargedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsChestedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsDyableComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsHiddenWhenInvisibleComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsIgnitedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsIllagerCaptainComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsSaddledComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsShakingComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsShearedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsStackableComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsStunnedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityIsTamedComponent extends IEntityComponent { readonly "id": string; }
    export class EntityItemComponent { readonly "itemStack": ItemStack; }
    export class EntityIterator implements Iterable<Entity> { [Symbol.iterator](): Iterator<Entity>; next(): IteratorResult<Entity>; }
    export class EntityLavaMovementComponent extends IEntityComponent { readonly "current": number; readonly "id": string; readonly "value": number; resetToDefaultValue(): void; resetToMaxValue(): void; resetToMinValue(): void; setCurrent(value: number): void; }
    export class EntityLeashableComponent extends IEntityComponent { readonly "id": string; readonly "softDistance": number; leash(leashHolder: Entity): void; unleash(): void; }
    export class EntityMarkVariantComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityMountTamingComponent extends IEntityComponent { readonly "id": string; setTamed(showParticles: boolean): void; }
    export class EntityMovementAmphibiousComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementBasicComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementComponent extends IEntityComponent { readonly "current": number; readonly "id": string; readonly "value": number; resetToDefaultValue(): void; resetToMaxValue(): void; resetToMinValue(): void; setCurrent(value: number): void; }
    export class EntityMovementFlyComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementGenericComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementGlideComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; readonly "speedWhenTurning": number; readonly "startSpeed": number; }
    export class EntityMovementHoverComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementJumpComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementSkipComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; }
    export class EntityMovementSwayComponent extends IEntityComponent { readonly "id": string; readonly "maxTurn": number; readonly "swayAmplitude": number; readonly "swayFrequency": number; }
    export class EntityNavigationClimbComponent extends IEntityComponent { readonly "avoidDamageBlocks": boolean; readonly "avoidPortals": boolean; readonly "avoidSun": boolean; readonly "avoidWater": boolean; readonly "canBreach": boolean; readonly "canBreakDoors": boolean; readonly "canFloat": boolean; readonly "canJump": boolean; readonly "canOpenDoors": boolean; readonly "canOpenIronDoors": boolean; readonly "canPassDoors": boolean; readonly "canPathFromAir": boolean; readonly "canPathOverLava": boolean; readonly "canPathOverWater": boolean; readonly "canSink": boolean; readonly "canSwim": boolean; readonly "canWalk": boolean; readonly "canWalkInLava": boolean; readonly "id": string; readonly "isAmphibious": boolean; }
    ...
    export class EntityPushThroughComponent extends IEntityComponent { readonly "id": string; "value": number; }
    ...
    export class EntityScaleComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntitySkinIdComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityStrengthComponent extends IEntityComponent { readonly "id": string; readonly "max": number; readonly "value": number; }
    export class EntityTameableComponent extends IEntityComponent { readonly "id": string; readonly "probability": number; readonly "tameEvent": Trigger; readonly "tameItems": string[]; tame(): boolean; }
    export class EntityUnderwaterMovementComponent extends IEntityComponent { readonly "current": number; readonly "id": string; readonly "value": number; resetToDefaultValue(): void; resetToMaxValue(): void; resetToMinValue(): void; setCurrent(value: number): void; }
    export class EntityVariantComponent extends IEntityComponent { readonly "id": string; "value": number; }
    export class EntityWantsJockeyComponent extends IEntityComponent { readonly "id": string; }
    export class Events { readonly "beforeChat": BeforeChatEventSignal; readonly "beforeDataDrivenEntityTriggerEvent": BeforeDataDrivenEntityTriggerEventSignal; readonly "beforeExplosion": BeforeExplosionEventSignal; readonly "beforeItemDefinitionEvent": BeforeItemDefinitionEventSignal; readonly "beforeItemUse": BeforeItemUseEventSignal; readonly "beforeItemUseOn": BeforeItemUseOnEventSignal; readonly "beforePistonActivate": BeforePistonActivateEventSignal; readonly "blockBreak": BlockBreakEventSignal; readonly "blockExplode": BlockExplodeEventSignal; readonly "blockPlace": BlockPlaceEventSignal; readonly "chat": ChatEventSignal; readonly "dataDrivenEntityTriggerEvent": DataDrivenEntityTriggerEventSignal; readonly "effectAdd": EffectAddEventSignal; readonly "entityCreate": EntityCreateEventSignal; readonly "entityHit": EntityHitEventSignal; readonly "explosion": ExplosionEventSignal; readonly "itemDefinitionEvent": ItemDefinitionEventSignal; readonly "itemUse": ItemUseEventSignal; readonly "itemUseOn": ItemUseOnEventSignal; readonly "pistonActivate": PistonActivateEventSignal; readonly "playerJoin": PlayerJoinEventSignal; readonly "playerLeave": PlayerLeaveEventSignal; readonly "tick": TickEventSignal; readonly "weatherChange": WeatherChangeEventSignal; }
    export class ExplosionEvent { readonly "dimension": Dimension; readonly "impactedBlocks": BlockLocation[]; readonly "source": Entity; }
    export class ExplosionEventSignal { subscribe(callback: (arg: ExplosionEvent) => void): (arg: ExplosionEvent) => void; unsubscribe(callback: (arg: ExplosionEvent) => void): void; }
    export class ExplosionOptions { "allowUnderwater": boolean; "breaksBlocks": boolean; "causesFire": boolean; "source": Entity; constructor(); }
    export class FeedItem { readonly "effects": FeedItemEffect[]; readonly "healAmount": number; readonly "item": string; }
    export class FeedItemEffect { readonly "amplifier": number; readonly "chance": number; readonly "duration": number; readonly "name": string; }
    export class FilterGroup { }
    export class FluidContainer { static readonly "maxFillLevel" = 6; static readonly "minFillLevel" = 0; }
    export class IBlockProperty { readonly "name": string; }
    export class IEntityComponent { readonly "id": string; }
    export class IntBlockProperty extends IBlockProperty { readonly "name": string; readonly "validValues": number[]; "value": number; }
    export class InventoryComponentContainer extends Container { readonly "emptySlotsCount": number; readonly "size": number; addItem(itemStack: ItemStack): void; getItem(slot: number): ItemStack; setItem(slot: number, itemStack: ItemStack): void; swapItems(slot: number, otherSlot: number, otherContainer: Container): boolean; transferItem(fromSlot: number, toSlot: number, toContainer: Container): boolean; }
    export class ItemCooldownComponent { readonly "cooldownCategory": string; readonly "cooldownTicks": number; readonly "id": string; startCooldown(player: Player): void; }
    export class ItemDefinitionEventSignal { subscribe(callback: (arg: ItemDefinitionTriggeredEvent) => void): (arg: ItemDefinitionTriggeredEvent) => void; unsubscribe(callback: (arg: ItemDefinitionTriggeredEvent) => void): void; }
    export class ItemDefinitionTriggeredEvent { readonly "eventName": string; "item": ItemStack; readonly "source": Entity; }
    export class ItemDurabilityComponent { "damage": number; readonly "damageRange": NumberRange; readonly "id": string; readonly "maxDurability": number; getDamageChance(unbreaking?: number): number; }
    export class ItemEnchantsComponent { "enchantments": EnchantmentList; readonly "id": string; removeAllEnchantments(): void; }
    export class ItemFoodComponent { readonly "canAlwaysEat": boolean; readonly "id": string; readonly "nutrition": number; readonly "saturationModifier": number; readonly "usingConvertsTo": string; }
    export class Items { static get(itemId: string): ItemType; }
    ...
    export class ItemType { readonly "id": string; }
    export class ItemUseEvent { "item": ItemStack; readonly "source": Entity; }
    export class ItemUseEventSignal { subscribe(callback: (arg: ItemUseEvent) => void): (arg: ItemUseEvent) => void; unsubscribe(callback: (arg: ItemUseEvent) => void): void; }
    export class ItemUseOnEvent { readonly "blockFace": Direction; readonly "blockLocation": BlockLocation; readonly "faceLocationX": number; readonly "faceLocationY": number; "item": ItemStack; readonly "source": Entity; }
    export class ItemUseOnEventSignal { subscribe(callback: (arg: ItemUseOnEvent) => void): (arg: ItemUseOnEvent) => void; unsubscribe(callback: (arg: ItemUseOnEvent) => void): void; }
    ...
    export class NavigationResult { readonly "isFullPath": boolean; readonly "path": BlockLocation[]; }
    export class NumberRange { "max": number; "min": number; next(): number; }
    export class PistonActivateEvent extends BlockEvent { readonly "block": Block; readonly "dimension": Dimension; readonly "isExpanding": boolean; readonly "piston": BlockPistonComponent; }
    export class PistonActivateEventSignal { subscribe(callback: (arg: PistonActivateEvent) => void): (arg: PistonActivateEvent) => void; unsubscribe(callback: (arg: PistonActivateEvent) => void): void; }
    export class PitchYawRotation { "pitch": number; "yaw": number; }
    export class Player extends Entity { readonly "bodyRotation": number; readonly "dimension": Dimension; readonly "headLocation": Location; readonly "id": string; "isSneaking": boolean; readonly "location": Location; readonly "name": string; "nameTag": string; "selectedSlot": number; "target": Entity; readonly "velocity": Vector; readonly "viewVector": Vector; addEffect(effectType: EffectType, duration: number, amplifier: number): void; addTag(tag: string): boolean; getBlockFromViewVector(options?: BlockRaycastOptions): Block; getComponent(componentId: string): IEntityComponent; getComponents(): IEntityComponent[]; getEffect(effectType: EffectType): Effect; getEntitiesFromViewVector(options?: EntityRaycastOptions): Entity[]; getItemCooldown(itemCategory: string): number; getTags(): string[]; hasComponent(componentId: string): boolean; hasTag(tag: string): boolean; kill(): void; playSound(soundID: string, soundOptions?: SoundOptions): void; removeTag(tag: string): boolean; runCommand(commandString: string): any; setVelocity(velocity: Vector): void; startItemCooldown(itemCategory: string, tickDuration: number): void; teleport(location: Location, dimension: Dimension, xRotation: number, yRotation: number): void; teleportFacing(location: Location, dimension: Dimension, facingLocation: Location): void; triggerEvent(eventName: string): void; }
    export class PlayerInventoryComponentContainer extends InventoryComponentContainer { readonly "emptySlotsCount": number; readonly "size": number; addItem(itemStack: ItemStack): void; getItem(slot: number): ItemStack; setItem(slot: number, itemStack: ItemStack): void; swapItems(slot: number, otherSlot: number, otherContainer: Container): boolean; transferItem(fromSlot: number, toSlot: number, toContainer: Container): boolean; }
    export class PlayerIterator implements Iterable<Player> { [Symbol.iterator](): Iterator<Player>; next(): IteratorResult<Player>; }
    export class PlayerJoinEvent { "player": Player; }
    export class PlayerJoinEventSignal { subscribe(callback: (arg: PlayerJoinEvent) => void): (arg: PlayerJoinEvent) => void; unsubscribe(callback: (arg: PlayerJoinEvent) => void): void; }
    export class PlayerLeaveEvent { readonly "playerName": string; }
    export class PlayerLeaveEventSignal { subscribe(callback: (arg: PlayerLeaveEvent) => void): (arg: PlayerLeaveEvent) => void; unsubscribe(callback: (arg: PlayerLeaveEvent) => void): void; }
    export class Seat { "lockRiderRotation": number; "maxRiderCount": number; "minRiderCount": number; "position": Location; }
    export class SoundOptions { "location": Location; "pitch": number; "volume": number; constructor(); }
    export class StringBlockProperty extends IBlockProperty { readonly "name": string; readonly "validValues": string[]; "value": string; }
    export class TickEvent { readonly "currentTick": number; readonly "deltaTime": number; }
    export class TickEventSignal { subscribe(callback: (arg: TickEvent) => void): (arg: TickEvent) => void; unsubscribe(callback: (arg: TickEvent) => void): void; }
    ...
    export class WeatherChangeEvent { readonly "dimension": string; readonly "lightning": boolean; readonly "raining": boolean; }
    export class WeatherChangeEventSignal { subscribe(callback: (arg: WeatherChangeEvent) => void): (arg: WeatherChangeEvent) => void; unsubscribe(callback: (arg: WeatherChangeEvent) => void): void; }
    export class World { readonly "events": Events; getDimension(dimensionId: "overworld" | "nether" | "the end"): Dimension; getPlayers(options?: EntityQueryOptions): PlayerIterator; playSound(soundID: string, soundOptions?: SoundOptions): void; }
