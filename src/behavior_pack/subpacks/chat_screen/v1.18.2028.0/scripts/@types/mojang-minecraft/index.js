...
export class Block {
  ...
  getTags() {};
  hasTag(tag) {};
  setPermutation(permutationPermutation) {};
  setType(blockTypeType) {};
};
...
export class DefinitionModifier {
  ...
  "triggers";
  constructor(componentGroupsToAdd, componentGroupsToRemove, triggers) {};;
};
...
export class Entity {
  ...
  "velocity";
  "viewVector";
  addEffect(effectTypeType, duration, amplifier) {};
  addTag(tag) {};
  getBlockFromViewVector(options) {};
  getComponent(componentId) {};
  getComponents() {};
  getEffect(effectTypeType) {};
