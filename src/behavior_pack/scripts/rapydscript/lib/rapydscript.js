...
function ՐՏ_merge(target, source, overwrite) {
    ...
    ՐՏitr97 = ՐՏ_Iterable(Object.getOwnPropertyNames(source.prototype));
    for (ՐՏidx97 = 0; ՐՏidx97 < ՐՏitr97.length; ՐՏidx97++) {
        prop = ՐՏitr97[ՐՏidx97];
...
ՐՏ_modules["ՐՏ:utils"].body = function(){
    ...
    }, ՐՏ_extends(ՐՏ_1, Error), (function(){
    ...
    }, ՐՏ_extends(ՐՏ_2, Error), (function(){
...
ՐՏ_modules["ՐՏ:ast"].body = function(){
    ...
    var EmptyStatement = (ՐՏ_12 = function EmptyStatement() {
        Statement.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_12, Statement), (function(){
    ...
    var Function = (ՐՏ_34 = function Function() {
        Lambda.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_34, Lambda), (function(){
    ...
    }, ՐՏ_extends(ՐՏ_71, PropAccess), (function(){
    ...
    var Sub = (ՐՏ_72 = function Sub() {
        PropAccess.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_72, PropAccess), (function(){
    ...
    }, ՐՏ_extends(ՐՏ_78, Binary), (function(){
    ...
    var DeepEquality = (ՐՏ_79 = function DeepEquality() {
        Binary.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_79, Binary), (function(){
    ...
    var Assign = (ՐՏ_81 = function Assign() {
        Binary.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_81, Binary), (function(){
    ...
    var Constant = (ՐՏ_108 = function Constant() {
        Node.prototype.__init__.apply(this, arguments);
    }, ՐՏ_extends(ՐՏ_108, Node), (function(){
...
ՐՏ_modules["ՐՏ:parser"].body = function(){
    ...
    function init_mod() {
        ...
        NATIVE_CLASSES = {
            ...
            "Error": {},
            "Object": {
                static: [ "assign", "getOwnPropertyNames", "keys", "create", "defineProperty", "defineProperties", "getPrototypeOf", "setPrototypeOf", "getOwnPropertyDescriptor", "getOwnPropertyDescriptors", "values", "entries", "fromEntries" ]
            },
            "String": {
                static: [ "fromCharCode" ]
            },
...
ՐՏ_modules["ՐՏ:output"].body = function(){
    ...
    (function() {
        ...
        ast.Class.prototype._do_print = function(output) {
            ...
            function addDecorators(class_postproc) {
                if (self.decorators && self.decorators.length) {
                    return function(obj) {
                        var output;
                        function internalsub() {
                            if (class_postproc) {
                                class_postproc.call(output, obj);
                            } else {
                                output.print(obj);
                            }
                        }
            ...
            function outputEs6() {
                var ՐՏ_186;
                function class_postproc(decorated_methods) {
                    ...
                    if (Object.keys(properties).length || decorated_methods && decorated_methods.length) {
                        function def_class_vars_and_decorators(obj) {
                            var ՐՏitr87, ՐՏidx87;
                ...
                }, ՐՏ_186 = unify(output, name, addDecorators(class_postproc(getES6DecoratedMethods())))(ՐՏ_186), ՐՏ_186);
                return generateClass;
            }
            function outputEs5() {
                var ՐՏupk10, ՐՏ_187;
                var methodsAndVars, staticmethods, class_vars, class_postproc;
                ...
                function addMethods() {
                    ...
                    return [methodAndVarOutput, staticMethodOutput, class_vars];
                }
                ՐՏupk10 = addMethods();
                methodsAndVars = ՐՏupk10[0];
                staticmethods = ՐՏupk10[1];
                class_vars = ՐՏupk10[2];
                if (methodsAndVars || staticmethods) {
                    function class_postproc(obj) {
                        var ՐՏitr88, ՐՏidx88;
                        var output, cb;
                        output = this;
                        ՐՏitr88 = ՐՏ_Iterable([ methodsAndVars, staticmethods ]);
                ...
                }, ՐՏ_187 = unify(output, name, addInheritance(), addDecorators(output.with_class_vars_init(class_vars, class_postproc)))(ՐՏ_187), ՐՏ_187);
                return generateClass;
            }
            if (output.option("es6")) {
        ...
        DEFPRINT(ast.Range, function(self, output) {
            ...
            indexes = [];
            ՐՏitr90 = ՐՏ_Iterable([ self.left, self.right ]);
            for (ՐՏidx90 = 0; ՐՏidx90 < ՐՏitr90.length; ՐՏidx90++) {
                element = ՐՏitr90[ՐՏidx90];
            ...
            if (indexes[0] && indexes[1] && Math.abs(indexes[1] - indexes[0]) < 50) {
                ...
                output.with_square(function() {
                    var ՐՏitr91, ՐՏidx91;
                    var i;
                    ՐՏitr91 = ՐՏ_Iterable(range(start, end, step));
        ...
        DEFPRINT(ast.ObjectLiteral, function(self, output) {
            var ՐՏitr92, ՐՏidx92, ՐՏ_189;
            var properties, p, v, key, v_key, h_, props, add_props;
            if (self.properties.length > 0) {
                properties = {};
                ՐՏitr92 = ՐՏ_Iterable(self.properties);
...
export var parse_baselib = function(srcPath, es6) {
    var ՐՏ_190, ՐՏitr93, ՐՏidx93;
    ...
    data = hash.body.properties;
    baselibList = {};
    ՐՏitr93 = ՐՏ_Iterable(data);
    for (ՐՏidx93 = 0; ՐՏidx93 < ՐՏitr93.length; ՐՏidx93++) {
        item = ՐՏitr93[ՐՏidx93];
        key = item.key.value;
        value = item.value.name ? [ item.value ] : item.value.body;
...
export var get_import_dirs = function(paths_string, ignore_env) {
    var paths, path;
    paths = [];
    path = require("path");
...
export var compile = compile = function(code, options) {
    ...
    if (!options.omit_baselib) {
        ...
        ՐՏitr94 = ՐՏ_Iterable(Object.keys(toplevel.baselib).filter(function(f) {
            return toplevel.baselib[f];
        }));
        for (ՐՏidx94 = 0; ՐՏidx94 < ՐՏitr94.length; ՐՏidx94++) {
            fun = ՐՏitr94[ՐՏidx94];
            ՐՏitr95 = ՐՏ_Iterable(baselib_dep_map);
            for (ՐՏidx95 = 0; ՐՏidx95 < ՐՏitr95.length; ՐՏidx95++) {
                rex_key = ՐՏitr95[ՐՏidx95];
...
export var minify = function(files, options) {
    var ՐՏitr96, ՐՏidx96;
    var file, code;
    ...
    ՐՏitr96 = ՐՏ_Iterable(files);
    for (ՐՏidx96 = 0; ՐՏidx96 < ՐՏitr96.length; ՐՏidx96++) {
        file = ՐՏitr96[ՐՏidx96];
...
export var string_template = utils.string_template;
export var ast = ast;
export var tokenizer = tokenizer;
export var NATIVE_CLASSES = parser.NATIVE_CLASSES;
export var ParseError = utils.ParseError;
export var ImportError = utils.ImportError;
export var ALL_KEYWORDS = tokenizer.ALL_KEYWORDS;
export var IDENTIFIER_PAT = tokenizer.IDENTIFIER_PAT;
export var colored = utils.colored;